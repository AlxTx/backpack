...
Backpack Engineering currently exposes the active phase and capability through separate
sentences. Repeating the `Backpack Engineering` prefix for the phase and again for a skill
...
```txt
[Backpack - <phase>] · <immediate action>
```
