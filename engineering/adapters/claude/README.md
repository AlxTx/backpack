...
The minimal Backpack Engineering core is linked into both `~/.claude/skills` and
...
design inherit the model selected by the user. Backpack Engineering applies the semantic tiers
from `engineering/portable/MODELS.md` to the models available in Claude. When a
